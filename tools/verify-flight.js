...
// 物理そのものを静かに数秒ぶん回して釣り合う姿勢へ収めてしまう。
{
  ...
  // 境目は2G。脚のばねを縮むほど硬くなるものに替えた（gearSpringRates）とき、
  // 静定させないこの場合も4.6G→2.4Gまで穏やかになったので下げた。
  // 下の「静定させれば半分以下」は、境目を下げても変わらず通っている。
  check(naiveResult.maxG > 2, 'この機体は、水平へ決め打ちで置くと接地で強く弾む（テストが効いている確認）',
