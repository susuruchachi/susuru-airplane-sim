...
//
// 稜線を歩いて峰を拾う仕組み（03b-world.js の worldGeneratePeaks）で見つかった
// いちばん高い山＝アクィルアヌム山 (Mt. Aquilanum) を山登りで詰めたところ、
// アストラ大山脈の x=-844098 z=-215512 で **4791.8m**。
// （格子を粗く切って探したときは4708.8mだったが、格子の目が峰をまたいでいた。
//   峰を拾う仕組みのほうが確実なので、そちらの最高値を使う）
// 山脈の作り方を変えたら必ず測り直すこと。ここが実際より低いと、
// 高い山にかすめて突っ込む場面を判定ごと素通りする。
// （稜線を引く方式にする前は4382.9mで、ここは4600だった）
const WORLD_MAX_TERRAIN_M = 5000;
